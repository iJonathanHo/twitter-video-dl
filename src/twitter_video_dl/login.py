"""
This module allows you to login to Twitter by providing a username and password for videos that require authentication.
"""
...
class TwitterLoginClient:
    ...
    def __init__(self, bear_token=BEARER_TOKEN, proxies=None):
